            ...
            <div class="row">
                ...
                <div class="main-content">
                    <div class="purchase-head mb-3">
                        <ul>
                            <a href="{{ route('get.purchase.view',get_data_user('web')) }}"><li>Chờ xử lý</li></a>
                            <a href="{{ route('get.purchase.processed.view',get_data_user('web')) }}"><li class="active">Đã xử lý</li></a>
                        </ul>
                    </div>
                    <div class="content">
                        <div class="p-4">
                            @if(isset($orders))
                                @foreach($orders as $order => $item)
                                    @if($item->transaction->tr_status == 1)
