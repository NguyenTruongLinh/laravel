                            ...
                            <div class="change-phone-stepper">
                                <div class="stepper">
                                    <div class="stepper_step stepper_step-pending">
                                        <div class="stepper_step-icon stepper_step-pending">
                                    ...
                                    <div class="stepper_step stepper_step-pending">
                                        <div class="stepper_step-icon">
                                            <div class="stepper_step-content stepper_step--finish">2</div>
                                        </div>
                                        <div class="stepper_step-text">Cập nhật số điện thoại</div>
                                    </div>
                                    <div class="stepper_line">
                                        <div class="stepper_line-background stepper_line-foreground"></div>
                                    </div>
                                </div>
                            </div>
                            <form action="" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-9 m-auto">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-right">Số điện thoại mới</label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" name="new_phone">
                                                @if ($errors->has('new_phone'))
                                                    <p class="text-danger">{{ $errors->first('new_phone') }}</p>
                                                @endif
                                            </div>
                                        </div>
